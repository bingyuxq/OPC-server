    ...
    public class OpcUaNodeManager : CustomNodeManager2
    {
        ...
        public override void CreateAddressSpace(IDictionary<NodeId, IList<IReference>> externalReferences)
        {
            lock (Lock)
            {
                ...
                {
                    Console.WriteLine(e.Message + "Error creating the ReferenceNodeManager address space.");
                }
        ...
        {
            if (m_generator == null)
            { Console.WriteLine("Need a random generator!"); return null; }
        ...
        private void DoSimulation(object state)
        {
            ...
            {
                Console.WriteLine(e.Message, "Unexpected error doing simulation.");
            }
        }
