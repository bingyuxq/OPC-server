...
{
    public partial class ReferenOpcUaReverseConnectServerceServer : ReverseConnectServer
    {
        ...
        private void SessionManager_ImpersonateUser(Session session, ImpersonateEventArgs args)
        {
            ...
            if (x509Token != null)
            {
                ...
                Console.WriteLine("X509 Token Accepted: {0}", args.Identity?.DisplayName);
        ...
        private IUserIdentity VerifyPassword(UserNameIdentityToken userNameToken)
        {
            ...
            if (userName == "sysadmin" && password == "demo")
            {
                ...
                userIdentity.GrantedRoleIds.Add(ObjectIds.WellKnownRole_SecurityAdmin);
        ...
        private IUserIdentity VerifyIssuedToken(IssuedIdentityToken issuedToken)
        {
            ...
            {
                Console.WriteLine("No TokenValidator is specified.");
                return null;
            }
            try
            {
                ...
                {
                    Console.WriteLine("VerifyIssuedToken: ValidateToken");
            ...
            catch (Exception e)
            {
                ...
                Console.WriteLine("VerifyIssuedToken: Throw ServiceResultExeption 0x{result:x}");
                throw new ServiceResultException(new ServiceResult(
                    result,
                    info.Key,
